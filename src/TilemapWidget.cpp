...
TilemapWidget::TilemapWidget(QWidget* parent, Level* level) : QDialog(parent, 0)
{
	...
	m_size->setRange(0.1, 100.0);
	m_size->setSingleStep(0.1);
	...
	m_layout->addRow(QString("Tile size:"), m_size);
...
float TilemapWidget::getSize()
{
	return m_size->value();
}

void TilemapWidget::setSize(float size)
{
